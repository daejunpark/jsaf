...
/* Converts a WIDL AST to a JS AST which is the concrete version of that node
 *
 * Caveats:
 ...
 */
class WIDLToJSAST(program: JList[WDefinition]) extends Walker {
...
*/
    ...
    case SWString(info, str) => // NF.makeStringLiteral
    case SWTSArray =>
    case SWTSQuestion =>
    ...
    */
    ...
    case _ =>
      NF.makeNoOp(NF.makeASTNodeInfo(NF.makeSpan("")), "")
  }
}
