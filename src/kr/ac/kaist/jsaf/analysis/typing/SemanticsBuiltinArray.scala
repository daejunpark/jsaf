                ...
                n_len match {
                  ...
                  case UIntSingle(n) => {
                    val _h = (0 until n_arg.toInt).foldLeft(hv._1)((__h, i) =>
                      Helper.PropStore(__h, l, AbsString.alpha((i+n).toInt.toString), getArgValue(h, ctx, (i.toString))))
          ...
          case (Some(start), Some(count)) =>
            lset_this.foldLeft((HeapBot, ObjBot))((_ho, l) => {
              ...
              val _h1 = n_arglen match {
                  case UIntSingle(n_arglen) => {
                    ...
                    if (add_count < count) {
                      ...
                      val __h2 = (0 until add_count).foldLeft(__h1)((__h, i) =>
                        Helper.PropStore(__h, l, AbsString.alpha((start + i).toInt.toString), getArgValue(__h, ctx_1, (i+2).toString)))
                  ...
                  case NumBot => HeapBot
                  case _ =>
                      val _h1 = Helper.PropStore(h_1, l, NumStr, getArgValueAbs(_h, ctx_1, NumStr))
              ...
              (_h + _h1, _o + o_1)
                ...
                case _ =>
                  ...
                  val _h1 = Helper.PropStore(_h, l, NumStr, getArgValueAbs(_h, ctx_1, NumStr))
                  val _h2 = Helper.Delete(_h1, l, NumStr)._1
                  (_h + _h2, _o + o_1)
              }
            })
              ...
              lset_this.foldLeft((HeapBot, ObjBot))((_ho, l) => {
                ...
                n_len match {
                  ...
                  case _ =>
                    ...
                    val _h1 = Helper.Delete(_h, l, NumStr)
                    val _h2 = Helper.PropStore(_h, l, NumStr, getArgValueAbs(_h, ctx_1, NumStr))
                    (_h2, _o + _o1)
                }
              })
            }
                ...
                n_len match {
                  case UIntSingle(k) => {
                    ...
                    val _h2 = (0 until n_arglen.toInt).foldLeft(_h1)((__h, i) => {
                      val v_i = getArgValue(h, ctx, i.toString)
