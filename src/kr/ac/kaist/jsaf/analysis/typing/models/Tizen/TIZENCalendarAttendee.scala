...
object TIZENCalendarAttendee extends Tizen {
  ...
  private val prop_cons: List[(String, AbsProperty)] = List(
    ...
    ("RSVP", AbsConstValue(PropValue(Value(UndefTop)))),
    ("type", AbsConstValue(PropValue(Value(UndefTop)))),
    ("group", AbsConstValue(PropValue(Value(UndefTop)))),
    ("delegatorURI", AbsConstValue(PropValue(Value(UndefTop)))),
    ("delegateURI", AbsConstValue(PropValue(Value(UndefTop)))),
    ("contactRef", AbsConstValue(PropValue(Value(UndefTop))))
  )
    ...
    Map(
      ("tizen.CalendarAttendee.constructor" -> (
        (sem: Semantics, h: Heap, ctx: Context, he: Heap, ctxe: Context, cp: ControlPoint, cfg: CFG, fun: String, args: CFGExpr) => {
          ...
          val h_3 = h_2.update(l_r1, o_contRef)
          ...
          val (h_4, es_1) = n_arglen match {
            ...
            case UIntSingle(n) if n == 1 =>
              val v_1 = getArgValue(h_3, ctx_2, args, "0")
              val o_new2 = o_new.
            ...
            case UIntSingle(n) if n == 2 =>
              ...
              val (v_3, v_4, v_5, v_6, v_7, v_8, v_9, v_10, v_11) =
                ...
                (_v._1 + Helper.LookupL(h_3, l, "name"), _v._2 + Helper.LookupL(h_3, l, "role"), _v._3 + Helper.LookupL(h_3, l, "status"),
                  _v._4 + Helper.LookupL(h_3, l, "RSVP"), _v._5 + Helper.LookupL(h_3, l, "type"), _v._6 + Helper.LookupL(h_3, l, "group"),
                  _v._7 + Helper.LookupL(h_3, l, "delegatorURI"), _v._8 + Helper.LookupL(h_3, l, "delegateURI"), _v._9 + Helper.LookupL(h_3, l, "contactRef"))
              })
              val o_new2 = o_new.
                update("uri", PropValue(ObjectValue(Value(Helper.toString(v_1._1)), F, T, T))).
