    ...
    Map(
      ("DOMCharacterData.substringData" -> (
        (sem: Semantics, h: Heap, ctx: Context, he: Heap, ctxe: Context, cp: ControlPoint, cfg: CFG, fun: String, args: CFGExpr) => {
          /* arguments */
          val n_offset = Helper.toNumber(Helper.toPrimitive(getArgValue(h, ctx, args, "0")))
          val n_count  = Helper.toNumber(Helper.toPrimitive(getArgValue(h, ctx, args, "1")))
      ...
      ("DOMCharacterData.appendData" -> (
        (sem: Semantics, h: Heap, ctx: Context, he: Heap, ctxe: Context, cp: ControlPoint, cfg: CFG, fun: String, args: CFGExpr) => {
          ...
          /* arguments */
          val s_arg = Helper.toString(Helper.toPrimitive(getArgValue(h, ctx, args, "0")))
          if (s_arg </ StrBot) {
            /* imprecise semantic */
      ...
      ("DOMCharacterData.insertData" -> (
        (sem: Semantics, h: Heap, ctx: Context, he: Heap, ctxe: Context, cp: ControlPoint, cfg: CFG, fun: String, args: CFGExpr) => {
          ...
          /* arguments */
          val n_offset = Helper.toNumber(Helper.toPrimitive(getArgValue(h, ctx, args, "0")))
          val s_arg    = Helper.toString(Helper.toPrimitive(getArgValue(h, ctx, args, "1")))
      ...
      ("DOMCharacterData.replaceData" -> (
        (sem: Semantics, h: Heap, ctx: Context, he: Heap, ctxe: Context, cp: ControlPoint, cfg: CFG, fun: String, args: CFGExpr) => {
          ...
          val n_offset = Helper.toNumber(Helper.toPrimitive(getArgValue(h, ctx, args, "0")))
          val n_count  = Helper.toNumber(Helper.toPrimitive(getArgValue(h, ctx, args, "1")))
          val s_arg    = Helper.toString(Helper.toPrimitive(getArgValue(h, ctx, args, "2")))
