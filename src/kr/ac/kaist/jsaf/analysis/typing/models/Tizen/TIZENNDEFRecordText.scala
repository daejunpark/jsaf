...
object TIZENNDEFRecordText extends Tizen {
  ...
  private val prop_cons: List[(String, AbsProperty)] = List(
    ...
    ("@construct",               AbsInternalFunc("TIZENtizen.TIZENNDEFRecordText.constructor")),
    ...
    ("text", AbsConstValue(PropValue(Value(UndefTop)))),
    ("languageCode", AbsConstValue(PropValue(Value(UndefTop)))),
    ("encoding", AbsConstValue(PropValue(Value(UndefTop))))
  )
  ...
  override def getSemanticMap(): Map[String, SemanticFun] = {
    Map(
/*      ("TIZENtizen.TIZENNDEFRecordText.constructor" -> ())*/
    )
  }
