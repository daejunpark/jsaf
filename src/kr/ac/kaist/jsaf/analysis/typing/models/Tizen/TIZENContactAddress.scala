...
object TIZENContactAddress extends Tizen {
  ...
  private val prop_cons: List[(String, AbsProperty)] = List(
    ...
    ("country", AbsConstValue(PropValue(Value(UndefTop)))),
    ("region", AbsConstValue(PropValue(Value(UndefTop)))),
    ("city", AbsConstValue(PropValue(Value(UndefTop)))),
    ("streetAddress", AbsConstValue(PropValue(Value(UndefTop)))),
    ("additionalInformation", AbsConstValue(PropValue(Value(UndefTop)))),
    ("postalCode", AbsConstValue(PropValue(Value(UndefTop)))),
