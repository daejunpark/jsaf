    ...
    e match {
        ...
        if (v_1 == ValueBot) {
          ...
          op.getText match {
            ...
            case "instanceof" =>
              ...
              val v_proto = lset_3.foldLeft(ValueBot)((v, l) => v + PreHelper.Proto(h,l,OtherStrSingle("prototype")))
              ...
              val b_1 = lset_1.foldLeft[Value](ValueBot)((v_1, l_1) =>
                lset_4.foldLeft[Value](v_1)((v_2, l_2) => v_2 + PreHelper.inherit(h, l_1, l_2)))
              val b_2 =
      ...
      case CFGUn(info, op, expr) =>
        ...
        op.getText match {
          ...
          case "typeof" => (Value(PreHelper.TypeTag(h, v)),es)
          case "+" => (uopPlus(v),es)
          case "-" => (uopMinus(v),es)
          case "~" => (uopBitNeg(v),es)
          case "!" => (uopNeg(v),es)
