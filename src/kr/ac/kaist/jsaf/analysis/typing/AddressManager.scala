...
import kr.ac.kaist.jsaf.analysis.cfg.InstId
...
object AddressManager {
  private class AddressManager {
    ...
    val allocTable: MMap[(Address, InstId, Int), Address] = MHashMap()
    ...
    def getAPIAddress(k1: Address, k2: InstId, k3: Int): Address = {
      val key = (k1, k2, k3)
  ...
  def getAPIAddress(k1: Address, k2: InstId, k3: Int): Address = manager.getAPIAddress(k1, k2, k3)
