  ...
  (function () 
  {
    ...
    {
      var B = YAHOO_config.listener, A = YAHOO.env.listeners, D = true, 
      C;
      if(B)
      {
  ...
  (function () 
  {
    var B = YAHOO.lang, A = Object.prototype, H = "[object Array]", 
    C = "[object Function]", 
    G = "[object Object]", 
    E = [], 
    F = ["toString", "valueOf", ], 
    D = {
      ...
      {
        var N, M, L, U, V, X, T = [], K, O = "dump", S = " ", I = "{", 
        W = "}", 
        Q, 
        P;
        for(;;)
...
{          return I;}
  ...
  (function () 
  {
    ...
    var E = YAHOO.util, L = YAHOO.lang, m = YAHOO.env.ua, A = YAHOO.lang.trim, 
    d = {
...
{                      }
      ...
      _setXY : (function (G, z) 
      {
        var AA = E.Dom._getStyle(G, p), y = E.Dom.setStyle, AD = z.pos, 
        Y = z.noRetry, 
      ...
      {
        var x = E.Dom.getDocumentScrollTop(), Y = E.Dom.getDocumentScrollLeft(), 
  ...
  {
    var C = Math.max(this.top, E.top), D = Math.min(this.right, E.right), 
  ...
  {
    var C = Math.min(this.top, E.top), D = Math.max(this.right, E.right), 
  ...
  {
    var F = YAHOO.util.Dom.getXY(D), C = F[1], E = F[0] + D.offsetWidth, 
  ...
  (function () 
  {
    var B = YAHOO.util, A = "clientTop", F = "clientLeft", J = "parentNode", 
    K = "right", 
    W = "hasLayout", 
    I = "px", 
    U = "opacity", 
    ...
    M = {
      ...
      {
        var b = Z[T][e], X = e.charAt(0).toUpperCase() + e.substr(1), 
        c = "offset" + X, 
        Y = "pixel" + X, 
        a = "", 
        d;
    ...
    YAHOO.util.Event = (function () 
    {
      ...
      return {
        ...
        startInterval : (function () 
        {
          if(! this._interval)
          {
            this._interval = YAHOO.lang.later(this.POLL_INTERVAL, this, this._tryPreloadAttach, null, 
            true);
          }
        }),
...
{            return false;}
    ...
    (function () 
    {
      ...
      if(EU.isIE)
      {
        ...
        {
          YAHOO.util.Event.onDOMReady(YAHOO.util.Event._tryPreloadAttach, YAHOO.util.Event, 
          true);
...
{              }
  ...
  YAHOO.util.EventProvider.prototype = {
    ...
    createEvent : (function (B, G) 
    {
      ...
      {
        F = new YAHOO.util.CustomEvent(B, E.scope || this, E.silent, YAHOO.util.CustomEvent.FLAT, 
        E.fireOnce);
        D[B] = F;
  ...
  (function () 
  {
    ...
    lang.augmentObject(DS, {
      ...
      {
        var locator = field.locator || field.key || field, xmldoc = context.ownerDocument || context, 
        result, 
        res, 
        value = null;
        try
{          if(! lang.isUndefined(xmldoc.evaluate))
          {
            result = xmldoc.evaluate(locator, context, xmldoc.createNSResolver(! context.ownerDocument ? context.documentElement : context.ownerDocument.documentElement), 
            0, 
            null);
...
{              }
        ...
        DS.issueCallback(oCallback, [oRequest, oParsedResponse, ], oParsedResponse.error, 
        oCaller);
      }),
...
{          }
      ...
      parseJSONData : (function (oRequest, oFullResponse) 
      {
        ...
        {
          var schema = this.responseSchema, fields = schema.fields, 
  ...
  YAHOO.util.Number = {
    format : (function (B, E) 
    {
      ...
      var C = B < 0, F = Math.abs(B), A = E.decimalPlaces, I = E.thousandsSeparator, 
      H, 
      G, 
      D;
      if(A < 0)
...
{        }
    ...
    {
      var E, A, G = (I && I.argument) ? I.argument : null, C = (B.r && B.r.statusText === "xdr:success") ? true : false, 
...
{        }
    ...
    {
      var F = 0, G = "communication failure", C = - 1, B = "transaction aborted", 
      E = {
  ...
  (function () 
  {
    ...
    function G(T, O, J) 
    {
      var S, I, R, P, W, Q = false, M = [], V = 0, L, N, K, U, 
      H;
      this.resetFormState();
      if(typeof T == "string")
      {
    ...
    function A(K, V, L, J) 
    {
      var Q = "yuiIO" + K.tId, R = "multipart/form-data", T = document.getElementById(Q), 
...
{          }
  ...
  YAHOO.widget.AutoComplete.prototype.filterResults = (function (l, n, r, m) 
  {
    ...
    if(l && l !== "")
    {
      ...
      var j = m.scope, q = this, c = r.results, o = [], b = j.maxResultsDisplayed, 
  ...
  {
    var c = this.maxResultsDisplayed, a = this._elList || document.createElement("ul"), 
    b;
...
{        }
  ...
  YAHOO.widget.AutoComplete.prototype._populateList = (function (n, f, c) 
  {
    ...
    if(h && ! f.error)
    {
      ...
      if(this._bFocused)
      {
        ...
        var u = f.results, a = Math.min(u.length, this.maxResultsDisplayed), 
  ...
  {
    var c = this.delimChar, f = - 1, g, e, b = c.length - 1, 
    d;
    for(;b >= 0;b --)
    {
      g = h.lastIndexOf(c[b]);
  ...
  YAHOO.widget.AutoComplete.prototype._moveSelection = (function (g) 
  {
    if(this._bContainerOpen)
    {
      ...
      var f = this._elList.childNodes[e], b = this._elContent, 
  ...
  YAHOO.util.Get = (function () 
  {
    ...
    }, L = 0, R = 0, E = false, N = YAHOO.env.ua, 
    S = YAHOO.lang;
    ...
    var G = (function (V, Z) 
    {
      ...
      var c = U.win, b = c.document, a = b.getElementsByTagName("head")[0], 
      W;
      if(U.url.length === 0)
      {
    ...
    var D = (function (Z) 
    {
      if(M[Z])
      {
        var T = M[Z], U = T.nodes, X = U.length, c = T.win.document, 
  ...
  (function () 
  {
    var l = YAHOO.lang, isFunction = l.isFunction, isObject = l.isObject, 
    isArray = l.isArray, 
    ...
    function _stringify(o, w, space) 
    {
      ...
      var replacer = isFunction(w) ? w : null, format = _toStr.call(space).match(/String|Number/) || [], 
      ...
      {
        var value = h[key], t = _type(value), a = [], colon = space ? COLON_SP : COLON, 
        arr, 
        i, 
        keys, 
        k, 
  ...
  (function () 
  {
    ...
    var b = (function (v, e, y, z) 
    {
      ...
      var w = [], s, D, G, r, u = true, t = b.isXML(e), A = v, 
      C, 
      F, 
      E, 
      x;
      ...
      if(w.length > 1 && k.exec(v))
      {
        if(w.length === 2 && f.relative[w[0]])
        {
          D = h(w[0] + w[1], e);
        }
        else
        {
          D = f.relative[w[0]] ? [e, ] : b(w.shift(), e);
          while(w.length)
          {
            v = w.shift();
            if(f.relative[v])
      ...
      {
        if(! z && w.length > 1 && e.nodeType === 9 && ! t && f.match.ID.test(w[0]) && ! f.match.ID.test(w[w.length - 1]))
        {
          C = b.find(w.shift(), e, t);
          e = C.expr ? b.filter(C.expr, C.set)[0] : C.set[0];
        }
        if(e)
        {
          C = z ? {
            expr : w.pop(),
            set : a(z)
          } : b.find(w.pop(), w.length === 1 && (w[0] === "~" || w[0] === "+") && e.parentNode ? e.parentNode : e, 
          t);
          D = C.expr ? b.filter(C.expr, C.set) : C.set;
          if(w.length > 0)
          {
            G = a(D);
          }
      ...
      if(d.call(G) === "[object Array]")
      {
        ...
        else
        {
          if(e && e.nodeType === 1)
          {
            for(x = 0;G[x] != null;x ++)
            {
              if(G[x] && (G[x] === true || G[x].nodeType === 1 && b.contains(e, G[x])))
              {
                y.push(D[x]);
              }
            }
    ...
    {
      var s = B, G = [], y = A, w, e, x = A && A[0] && b.isXML(A[0]);
      while(B && A.length)
      {
        for(var z in f.filter)
        {
          if((w = f.leftMatch[z].exec(B)) != null && w[2])
          {
            var r = f.filter[z], F, D, t = w[1];
            e = false;
            w.splice(1, 1);
    ...
    var f = b.selectors = {
      ...
      relative : {
        "+" : (function (w, r) 
        {
          ...
          for(var s = 0, e = w.length, u;s < e;s ++)
          {
            if((u = w[s]))
            {
        ...
        ">" : (function (w, r) 
        {
          var u = typeof r === "string", v, s = 0, e = w.length;
          if(u && ! /\W/.test(r))
          {
            r = r.toLowerCase();
            for(;s < e;s ++)
      ...
      filter : {
        ...
        ATTR : (function (v, t) 
        {
          var s = t[1], e = f.attrHandle[s] ? f.attrHandle[s](v) : v[s] != null ? v[s] : v.getAttribute(s), 
          w = e + "", 
          u = t[2], 
          r = t[4];
...
{              }
  ...
  (function () 
  {
    ...
    A.prototype = {
      ...
      {
        S = S.toLowerCase();
        var R = this.config[S], K = false, J, G, H, I, O, Q, F, M, 
        N, 
        D, 
        L, 
        T, 
  ...
  (function () 
  {
    ...
    var F = YAHOO.util.Dom, D = YAHOO.util.Config, N = YAHOO.util.Event, 
  ...
  (function () 
  {
    ...
    var I = YAHOO.lang, M = YAHOO.util.CustomEvent, G = YAHOO.widget.Module, 
    N = YAHOO.util.Event, 
    F = YAHOO.util.Dom, 
    D = YAHOO.util.Config, 
    K = YAHOO.env.ua, 
    ...
    YAHOO.extend(B, G, {
      ...
      {
        var Q = O[0], S = F.getStyle(this.element, "visibility"), 
      ...
      {
        var S = B.VIEWPORT_OFFSET, Q = this.element, T = Q.offsetWidth, 
        R = Q.offsetHeight, 
      ...
      {
        var U = Q[0], P = D.alreadySubscribed, R = B.windowResizeEvent, 
      ...
      {
        var V = S[0], Q = this.cfg, U = "autofillheight", W = "height", 
        R = Q.getProperty(U), 
      ...
      syncIframe : (function () 
      {
        var O = this.iframe, Q = this.element, S = B.IFRAME_OFFSET, 
        P = (S * 2), 
        R;
        if(O)
        {
      ...
      configContext : (function (U, T, Q) 
      {
        ...
        if(X)
        {
          ...
          if(R)
          {
            if(typeof R == "string")
            {
              this.cfg.setProperty("context", [document.getElementById(R), O, V, S, P, ], 
              true);
            }
            if(O && V)
            {
      ...
      {
        var V = this.cfg.getProperty("context"), T = this, O, Q, 
        U;
        function R(Z, a) 
        {
          var Y = null, X = null;
      ...
      {
        var T = this.element, R = B.VIEWPORT_OFFSET, Z = (X == "x"), 
      ...
      {
        var Z = (X == "x"), T = B.VIEWPORT_OFFSET, S = this, Q = (Z) ? F.getX(W) : F.getY(W) - b, 
      ...
      center : (function () 
      {
        var R = B.VIEWPORT_OFFSET, S = this.element.offsetWidth, 
      ...
      fillHeight : (function (R) 
      {
        if(R)
        {
          var P = this.innerElement || this.element, O = [this.header, this.body, this.footer, ], 
          V, 
          W = 0, 
          X = 0, 
          T = 0, 
      ...
      bringToTop : (function () 
      {
        ...
        function V(Z, Y) 
        {
          var b = F.getStyle(Z, "zIndex"), a = F.getStyle(Y, "zIndex"), 
  ...
  (function () 
  {
    ...
    var D = YAHOO.widget.Overlay, C = YAHOO.util.Event, E = YAHOO.util.Dom, 
    B = YAHOO.util.Config, 
    ...
    A.prototype = {
      ...
      find : (function (G) 
      {
        var K = G instanceof D, I = this.overlays, M = I.length, 
        J = null, 
        L, 
        H;
  ...
  (function () 
  {
    ...
    A.SLIDE = (function (F, D) 
    {
      ...
      {
        var P = B.getViewportWidth(), S = B.getXY(R.overlay.element), 
        Q = S[1];
    ...
    A.prototype = {
      init : (function () 
      {
        ...
        this.animIn = new this.animClass(this.targetElement, this.attrIn.attributes, this.attrIn.duration, 
        this.attrIn.method);
        this.animIn.onStart.subscribe(this.handleStartAnimateIn, this);
        this.animIn.onTween.subscribe(this.handleTweenAnimateIn, this);
        this.animIn.onComplete.subscribe(this.handleCompleteAnimateIn, this);
        this.animOut = new this.animClass(this.targetElement, this.attrOut.attributes, this.attrOut.duration, 
        this.attrOut.method);
...
{          }
    ...
    {
      b = location.hash.match(d) ? true : false;
    }), 
    1000);
    window.LI.log = (function () 
    {
      ...
      if(c)
      {
        return YAHOO.log.apply(YAHOO, h);
      }
      if(g)
      {
        return e.push(h);
      ...
      {
        YAHOO.util.Get.css("http://yui.yahooapis.com/2.8.0r4/build/logger/assets/skins/sam/logger.css");
        YAHOO.util.Get.script(["http://yui.yahooapis.com/2.8.0r4/build/dragdrop/dragdrop-min.js", "http://yui.yahooapis.com/2.8.0r4/build/logger/logger-min.js", ], 
        {
          onSuccess : (function () 
          {
            ...
            var l = new YAHOO.widget.LogReader(m, {
              width : "500px",
              height : "300px",
              draggable : true,
              verboseOutput : false,
            ...
            YAHOO.widget.Logger.categoryCreateEvent.subscribe((function (u, r) 
            {
              var s = ((new Date()).getTime() + "").substr(- 6);
              var w = "";
              var o = "";
  ...
  (function () 
  {
    ...
    {
      LI.log(message, "info", "controls.js");
    });
    ...
    var _addControl = (function (id, objectName, config) 
    {
      ...
      var targetEl = YDom.getPreviousSiblingBy(scriptNode, (function (nd) 
      {
        return (nd.tagName.toLowerCase() != "script") && ! YDom.hasClass(nd, "li-control") ? true : false;
      }));
    ...
    var __addControl = (function (targetEl, objectName, config, scriptNode, lazy, lazyConfig) 
    {
      ...
      if(lazyConfig && lazyConfig.loaded === false)
      {
        var loader = new LI.Loader({
          require : ["LI." + objectName.replace(/^li\./i, ""), ],
          onSuccess : (function () 
          {
...
{        log("addControl: Exception thrown (requeue): " + YAHOO.lang.dump(e));
        return enqueue(targetEl, objectName, config, scriptNode);}
...
{          log("processQueue: Exception thrown (requeue)");
      ...
      {
        var uninitializedControls = [];
        for(var i = 0, len = newQueue.length;i < len;i ++)
        {
...
{            error("Could not get exception for item " + i);}
    ...
    {
      return Y$('*[id^="control-"].li-control', domNode);
    });
    var _parseFragment = (function (domNode) 
    {
      ...
      for(var i = 0, len = controlNodes.length;i < len;i ++)
      {
    ...
    {
      var innerHTMLException, ieTextException, appendChildException, 
      el, 
      content = [], 
...
{        eval(content);}
    ...
    var _register = (function (name, dependencies) 
    {
      YAHOO.register(name, null, {
    ...
    var _registerCustomLazyLoad = (function (id, controlName, config, lazyConfig) 
    {
      ...
      {
        __addControl(targetEl, controlName, config, scriptNode, true, {
          loaded : false
        });
      }));
    });
    ...
    {
      var target = YEvent.getTarget(evt), on, config, scriptNode, 
      controlData;
      while(target)
      {
        sibling = target;
        while(sibling = YDom.getNextSibling(sibling))
        {
          on = false;
          ...
          if(! on && (sibling.tagName.toLowerCase() != "script") && ! YDom.hasClass(sibling, "li-control"))
          {
            break;
          }
        }
    ...
    YEvent.onDOMReady((function () 
    {
      log("YEvent: onDOMReady Control Initialization");
      LI.Controls.processQueue();
    }));
    YEvent.on(win, "load", (function () 
    {
  ...
  LI.i18n = (function () 
  {
    ...
    function e() 
    {
      ...
      if(i)
      {
        g = i.replace(/.*lang=([^\&]*).*/g, "$1");
        h = /^(.{2})[-_](.{2})$/i.exec(g);
        if(h && h.length === 3)
        {
          f.language = h[1].toLowerCase();
  ...
  LI.injectAlert = (function (c, h, b, a, i, j) 
  {
    var k = (! b) ? YDom.get("global-error") : YDom.get(b);
    k.innerHTML = "";
    var e = '<div class="alert {type}" role="alert"><p><strong>{msg}</strong></p>', 
    f = {
      msg : c,
      type : h
    }, 
    g = (typeof i === "undefined") ? false : (! ! i);
    if(g)
    {
      e += '<a href="#" class="dismiss" id="dismiss-alert" role="button">';
      if(j)
      {
        e += "{closeMsg}";
        f.closeMsg = j;
    ...
    if(g)
    {
      YEvent.on("dismiss-alert", "click", (function (m) 
      {
  ...
  LI.removeAlert = (function (c, b) 
  {
    var a = (! c) ? YDom.get("global-error") : YDom.get(c);
    if(b && YAnim)
    {
      YDom.setStyle(a, "overflow", "hidden");
      var d = new YAnim(a, {
        opacity : {
          to : 0
        },
  ...
  {
    b = YDom.get(b), e = (! e) ? "#ddf0f8" : e, c = (! c) ? "#ffffff" : c, 
    d = (! d) ? 1.5 : d;
  ...
  {
    var c = parseInt(YDom.getStyle(b, "borderTopWidth"), 10), 
    a = parseInt(YDom.getStyle(b, "borderBottomWidth"), 10);
    c = isNaN(c) ? 0 : c;
    a = isNaN(a) ? 0 : a;
  ...
  LI.inViewPort = (function (b, e) 
  {
    ...
    var d = YDom.getDocumentScrollTop(), a = YDom.getRegion(b), 
    c = parseInt(d + e, 10);
...
{      f = {
  ...
  {
    var a = "", d = "content", c = Y$("meta[name=treeID]")[0], 
    b = a;
    if(c)
    {
      b = c.getAttribute(d);
  ...
  LI.asyncRequest = (function (d, a, h, e) 
  {
    var b = YAHOO.util.Connect._sFormData;
    h = h || {
    ...
    var c = (function (m, p) 
    {
      ...
      for(var l = 0, k = m.split(/&/), j = k.length;l < j;l ++)
      {
        var o = k[l].split(/\=/);
    ...
    var g = {
      ...
      handleException : (function (k) 
      {
        ...
        if(this.oCallback && this.oCallback.custom && this.oCallback.custom.exception)
        {
          ...
          {
            j = this.oCallback.custom.exception.apply(this.oCallback.scope, [k, ]);
          }
          else
          {
            j = this.oCallback.custom.exception(k);
          }
        }
        if(j)
        {
      ...
      success : (function (k) 
      {
        if(k.responseText === "")
        {
          if(! this.oCallback.scope)
          {
            this.oCallback.success(k);
          }
          else
          {
            this.oCallback.success.apply(this.oCallback.scope, [k, ]);
          }
          return;
        }
        ...
        if(n === "fail")
        {
          if(u)
          {
            if(u.globalError)
            {
              LI.injectAlert(u.globalError, "error");
            }
            if(u.form || u.fieldErrors)
            {
              var t = u.form || u.fieldErrors;
              for(var p = 0, j = YDom.getElementsByClassName("error", "span"), 
              q = j.length;p < q;p ++)
              {
                var l = j[p];
            ...
            if(this.oCallback && this.oCallback.custom && this.oCallback.custom.error)
            {
              if(this.oCallback.scope)
              {
                this.oCallback.custom.error.apply(this.oCallback.scope, [u, ]);
              }
              else
              {
                this.oCallback.custom.error(u);
              }
            }
            return;
          }
      ...
      customevents : (h && h.customevents) ? h.customevents : null,
      argument : (h && h.argument) ? h.argument : null,
      upload : (h && h.upload) ? h.upload : null,
      cache : (h && h.cache) ? h.cache : false,
      scope : g,
      timeout : (h && h.timeout) ? h.timeout : null
    };
    LI.originUUID();
  ...
  (function () 
  {
    ...
    LI.showAllDeferredImg = (function (n, g) 
    {
      ...
      var a = (g === false) ? false : true, l = (n) ? n : null, 
      h = YDom.getElementsByClassName("img-defer-hidden", "img", l), 
      e = h.length;
      for(var d = 0;e > d;d ++)
      {
        var b = h[d];
  ...
  (function () 
  {
    ...
    LI.setABId = (function (d) 
    {
      ...
      LI.log("tmemid active: " + b[1] + " (applies to subsequent page loads)", 
      c, 
      a);
    });
    LI.getABId = (function () 
    {
      LI.log("Your AB Override is: " + LI.readCookie("tmemid"), c, 
      a);
    });
...
{      window.scrollTo((j[0] + f), (j[1] + b));
  ...
  {
    var f, h, m = b.indexOf("?"), a = (m >= 0) ? b.substr(m + 1) : b, 
    d, 
    k, 
    g = {
...
{          l = unescape(k[1].replace(/\+/g, " "));}
  ...
  LI.browser = (function () 
  {
    var g = ! ! document.all, c = g && ! ! window.atob, h = g && ! ! document.addEventListener && ! c, 
    a = g && ! ! document.querySelector && ! document.addEventListener, 
    b = g && ! ! window.XMLHttpRequest && ! document.querySelector, 
    e = g && ! ! document.compatMode && ! window.XMLHttpRequest, 
  ...
  if(typeof Lui.Url == "undefined")
  {
    ...
    Lui.Url = (function (b) 
    {
      if(LI.__HPA === true)
      {
        console.info('HOMEPAGE_PERFORMANCE_ANALYSIS :: lib/lui/linkedin_url-min.js');
      }
  ...
  LI.NavigationMenu = (function (d, x) 
  {
    ...
    var q = "nav-primary-shim", m = 25, f = 250, o = 999, r = o + "+", 
    c, 
    t, 
    j, 
    w;
    ...
    function u(z, y) 
    {
      var B = y ? (y[0] ? y[0] : y) : YEvent.getTarget(z), C = s(B), 
      A;
      if(! C)
      {
        if(j)
    ...
    function h(z) 
    {
      var E = YEvent.getTarget(z), B = g(E, "inbox-item"), y, A, 
      D, 
      C;
      if(B)
      {
    ...
    if(n.inbox && n.inbox.enableRealTimeUpdate)
    {
      var k = (function k(B) 
      {
        var A = YDom.get("inbox-pending-invitation-count"), C = YDom.get("inbox-unread-message-count"), 
        E = B.invitations.pending, 
        y = B.messages.unread, 
        z = E + y, 
        D = YDom.get("nav-primary-inbox-item-total ");
        if(A)
        {
  ...
  (function () 
  {
    var x = "data-li-action-type", e = ".activity-drop-body", 
    I = "data-li-activity-type", 
    B = {
      actor_count : true,
      impression_ID : true,
      isNew : true,
    ...
    H = "is-backfilling", 
    A = "last", 
    J = '<div class="activity-drop activity-drop-loading"><div class="activity-drop-body"></div></div>', 
    s = "messages", 
    k = "mouseover", 
    E = "notifications", 
    a = "data-li-num-remaining", 
    C = "post", 
    n = "SUCCESS", 
    l = "unseen", 
    c = "unsubscribe-confirm", 
    g = "unsubscribe-link", 
    d = "unsubscribe-success", 
    m = "unviewed", 
    j = "update", 
    o = location.search.match(/mock=true/), 
    F = "utilities", 
    f = YAHOO.lang;
    function b(K) 
    {
      return p(K, "mock", "true");
    }
    function D(K, L) 
    {
      return p(K, "offset", L);
    ...
    function p(K, M, L) 
    {
      return [K, ((K.indexOf("?") > 0) ? "&" : "?"), encodeURIComponent(M), "=", encodeURIComponent(L), ].join("");
    }
    function q(N) 
    {
      var Q = YAHOO.util.Get, P = N.dependencies, K, O;
      if(typeof P === "string")
      {
        P = LI.Controls.resolveName(P);
      }
    ...
    function u(L, O) 
    {
      ...
      function N(V) 
      {
        return G(V, "activity-item");
      }
      function U(V) 
      {
        return G(V, "activity-toggle");
      }
      function K(V) 
      {
        return G(V, "activity-tab");
      }
      function T(ag) 
      {
        var aa = (function () 
        ...
        ac, 
        V;
        if(ab && O.hoverMenus && YDom.inDocument(af) && (YDom.getAttribute(ab, "href") === "#"))
        {
          YEvent.preventDefault(ag);
          this.toggleTab(Z);
        }
        else
        {
          if(! this.locked && YDom.inDocument(af))
          {
            if(ab && ! O.hoverMenus)
            {
              YEvent.preventDefault(ag);
            ...
            else
            {
              if(this.activeTab)
              {
                ...
                else
                {
                  ...
                  {
                    if(YDom.hasClass(af, "reply-to-invite") || YDom.hasClass(af, "inviter-send-msg"))
                    {
                      this.closeTab(this.activeTab);
                    }
                    else
                    {
                      if(YDom.hasClass(af, "notification-link"))
                      {
                        YEvent.preventDefault(ag);
                        ac = G(af, j);
                      ...
                      {
                        if(YDom.hasClass(af, g) || YDom.hasClass(af, "unsubscribe-cancel-action"))
                        {
                          YEvent.preventDefault(ag);
                          ac = G(af, j);
                          if(YDom.hasClass(af, g))
                          {
                            YDom.replaceClass(ac, h, c);
                          }
                          else
                          {
                            YDom.replaceClass(ac, c, h);
                          }
                          W = P(ac, Z, {
                            notification_ID : true,
                            notification_type : true
                        ...
                        {
                          if(YDom.hasClass(af, "unsubscribe-action"))
                          {
                            YEvent.preventDefault(ag);
                            if(af.href)
                            {
                              ac = G(af, j);
                              LI.asyncRequest(r, af.href, {
                                failure : aa,
                                scope : this,
                                success : (function (ai) 
                                {
                                  var ah = ai.responseText;
                                  if(ah && ah.result === n)
                                  {
                                    YDom.replaceClass(ac, c, d);
                                  }
                                })
                              });
                              W = P(ac, Z, {
      ...
      function P(X, ab, Y) 
      {
        ...
        if(Y.actor_count === true)
        {
          V.actor_count = YDom.getAttribute(X, "data-li-num-actors");
        }
        if(Y.impression_ID === true)
        {
          V.impression_ID = YDom.getAttribute(X, "data-li-impr-id");
        }
        if(Y.isNew === true)
        {
          V.isNew = YDom.hasClass(X, "seen");
        }
        if(Y.notification_ID === true)
        {
          V.notification_ID = YDom.getAttribute(X, "data-li-id");
        }
        if(Y.notification_type === true)
        {
          V.notification_type = YDom.getAttribute(X, "data-li-type");
        }
        if(Y.service_provider === true)
        {
          V.service_provider = "on-site";
        }
        if(Y.sub_ID === true)
        {
          V.sub_ID = YDom.getAttribute(X, "data-li-sub-id");
        }
        if(Y.position === true)
        {
          W = Y$(".activity-drop-body li.update", ab);
          Z = W.length;
          for(aa = 0;aa < Z;aa ++)
          {
            ac = W[aa];
      ...
      function S(V) 
      {
        var X = YEvent.getTarget(V), W = K(X);
        if(! this.activeTab || W !== this.activeTab)
        {
          this.openTab(W);
      ...
      function R(V) 
      {
        var X = YEvent.getTarget(V), W = K(X) !== null;
        if(! W)
        {
          YEvent.removeListener(document, k, R);
          if(this.activeTab)
          {
            this.closeTab(this.activeTab);
          }
      ...
      function Q(ap) 
      {
        var af = ap.invitations, al = YDom.hasClass(L, F), an = ap.messages, 
        ag = ap.notifications.unseen, 
        am = Y$(".activity-tab", L), 
        X = (YDom.getAttribute(L, "data-li-update-type") === l), 
        ad, 
        ae, 
        W, 
        V, 
        ...
        Z = ao + ah;
        for(aj = 0, ak = am.length;aj < ak;aj ++)
        {
          aa = am[aj];
          ...
          if(ab)
          {
            ...
            if(Y)
            {
              ...
              if(al)
              {
                ad = Y$(".activity-container", aa, true);
                ad.appendChild(ac);
              }
              else
              {
      ...
      if(O.enableRealTimeUpdate)
      {
        M = LI.NotificationsCountUpdatesService.getInstance();
    ...
    u.prototype = {
      ...
      openTab : (function (N) 
      {
        var P = this, M = YDom.getElementsByClassName("activity-drop", "div", N)[0], 
        L = YDom.getElementsByClassName("activity-drop-loading", "div", N)[0], 
        Q = YDom.getAttribute(N, "data-li-action-type-click"), 
        S = YDom.getAttribute(N, "data-li-new-count"), 
        T, 
        U, 
        O, 
        R;
        function K(Z) 
        {
          var Y, aa, X = Z.url, W = Z.backfillUrl, V = (Z.infiniteScroll === true), 
          ac = YDom.getAttribute(N, "data-li-action-type-pagination");
          if(o)
          {
            if(W)
            {
          ...
          function ab() 
          {
            var ag = Y$(".activity-drop-body ol", N)[0], ae = this, ad, 
            af = W;
            if(! P.locked && YDom.hasClass(ag, v))
            {
              ad = Y$("li.update", ag).length;
              af = D(af, ad);
              YDom.addClass(L, H);
              this.render();
              if(f.isString(ac) && ac.length)
              {
                WebTracking.trackUserAction(ac, null, true);
              }
              P.locked = true;
              LI.asyncRequest("GET", af, {
                custom : {
                  exception : aa
                },
                failure : aa,
                success : (function (am) 
                {
                  ...
                  if(! LI.isFullPage(Y))
                  {
                    ah = Y$("li.loading", ag)[0];
                    M = LI.domify(Y);
                    for(ai = M.firstChild;ai;ai = ai.nextSibling)
                    {
                      if(ai.tagName && (ai.tagName.toLowerCase() === "li"))
                      {
                        al = ai.cloneNode(true);
                        if(ah)
                        {
                          ag.insertBefore(al, ah);
                        }
                        else
                        {
                          ag.appendChild(al);
          ...
          LI.asyncRequest("GET", X, {
            success : (function (ag) 
            {
              ...
              if(! LI.isFullPage(Y))
              {
                ...
                {
                  af = Y$(e, L)[0];
                  ad = new LI.ScrollTopObserver(af, {
        ...
        if(f.isString(Q) && Q.length && f.isString(S) && S.length)
        {
          WebTracking.trackUserAction(Q, {
            alert_count : S
          }, true);
        }
        this.activeTab = N;
        if(N && (! M || YDom.hasClass(M, "activity-drop-loading")))
        {
          T = N.getAttribute(I);
          if(T)
          {
            O = this.remoteMenus[T];
            if(O)
            {
              if(L)
              {
      ...
      markViewed : (function (L) 
      {
        var K = L.getAttribute(I), O = YDom.getElementsByClassName(t, "span", L)[0], 
        M = YDom.getElementsByClassName(m, "", L), 
        N = YDom.getElementsByClassName(l, "", L);
        if(O)
        {
          if(K === E || (K === s && YDom.hasClass(O, i)))
          {
            O.parentNode.removeChild(O);
          }
          else
          {
            YDom.removeClass(O, y);
          }
        }
        if(M)
        {
          YDom.removeClass(M, m);
        }
        if(N)
        {
          YDom.removeClass(N, l);
        }
      }),
  ...
  function SearchWebTrack() 
  {
    function a(b) 
    {
      if(document.images)
      {
        (new Image()).src = SearchWebTracking.saveSearchWebActionTrackURL + "&" + b;
      }
    }
    this.trackScoutAction = (function (d, e, g, f, c, h) 
    {
      var b = "pk=" + escape(LI.getPageKey()) + "&ck=" + escape(d) + "&ak=" + escape(e) + "&p=" + escape(g) + "&pd=" + escape(c);
      if(f)
      {
        b += "&pn=" + escape(f);
      }
    ...
    this.trackScoutActionEncrypted = (function (d, e, g, f, c, h) 
    {
      var b = "pk=" + escape(LI.getPageKey()) + "&ck=" + escape(d) + "&ak=" + escape(e) + "&p=" + escape(g) + "&pn=" + escape(f) + "&pd=" + escape(c);
      a(b);
    });
  }
  ...
  LI.GhostLabel = (function (c, r) 
  {
    var h = YDom.get(c.htmlFor), j, a, g = "password", b = ! ! ("placeholder" in document.createElement("input") && "placeholder" in document.createElement("textarea")), 
    o = "ghost-hide", 
    l = "ghost-show", 
    e = "hint", 
    i = "clone-hint", 
    ...
    r = {
      placeholder : (YAHOO && YAHOO.lang && YAHOO.lang.trim) ? YAHOO.lang.trim(r.placeholder || c.firstChild.nodeValue) : (r.placeholder || c.firstChild.nodeValue),
      showLabel : r.showLabel || false,
      isDefault : r.isDefault || false
    };
    if(b)
    {
      h.setAttribute("placeholder", r.placeholder);
    }
    var s = (function () 
    {
      if(! b)
      {
        if(r.placeholder && h.value === "")
        {
          if(h.type === g)
          {
            if(! j)
    ...
    var t = (function () 
    {
      if(! b)
      {
        if(r.placeholder && (h.value === r.placeholder) && YDom.hasClass(h, e))
        {
          if(j && h.type === g)
          {
            if(a)
    ...
    var n = (function () 
    {
      ...
      if(! b)
      {
        ...
        YEvent.on(h, "blur", s);
        if(r.placeholder && (h.value === r.placeholder))
        {
          h.value = "";
          YDom.removeClass(h, e);
        }
      ...
      if(u)
      {
        YEvent.on(u, "submit", m);
      }
      if(u && u.id && h.id)
      {
        LI.GhostLabel.Manager.register(u.id, h.id, k);
      }
    });
    n();
  ...
  function FocusField(b, a) 
  {
    ...
    if(! b)
    {
      b = Y$("input[type=text], input[type=password], textarea, select", 
      "main", 
      true);
    }
