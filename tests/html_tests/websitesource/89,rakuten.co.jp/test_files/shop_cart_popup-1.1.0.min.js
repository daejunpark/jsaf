/*
 shop_cart_popup 1.1.0
 Copyright (c) 2013 Rakuten.Inc
 Date : 2013-04-05 17:19:59 
*/
(function(i){function o(b){var a=[].slice.call(arguments,1),c=0,b=i.event.fix(b||window.event);b.type="mousewheel";b.wheelDelta&&(c=b.wheelDelta/120);b.detail&&(c=-b.detail/3);a.unshift(b,c);return i.event.handle.apply(this,a)}var b=["DOMMouseScroll","mousewheel"];i.event.special.mousewheel={setup:function(){if(this.addEventListener)for(var d=b.length;d;)this.addEventListener(b[--d],o,!1);else this.onmousewheel=o},teardown:function(){if(this.removeEventListener)for(var d=b.length;d;)this.removeEventListener(b[--d],
o,!1);else this.onmousewheel=null}};i.fn.extend({mousewheel:function(b){return b?this.bind("mousewheel",b):this.trigger("mousewheel")},unmousewheel:function(b){return this.unbind("mousewheel",b)}})})(jQuery);
(function(i){var o={init:function(b){b=i.extend(!0,{set_width:!1,set_height:!1,horizontalScroll:!1,scrollInertia:550,scrollEasing:"easeOutCirc",mouseWheel:"auto",autoDraggerLength:!0,scrollButtons:{enable:!1,scrollType:"continuous",scrollSpeed:20,scrollAmount:40},advanced:{updateOnBrowserResize:!0,updateOnContentResize:!1,autoExpandHorizontalScroll:!1},callbacks:{onScroll:function(){},onTotalScroll:function(){},onTotalScrollOffset:0}},b);i(document).data("mCS-is-touch-device",!1);"ontouchstart"in
...
g=j.children(".mCSB_dragger");if(b.data("horizontalScroll")){var f=c.children(".mCSB_buttonLeft"),h=c.children(".mCSB_buttonRight"),e=d.width();b.data("autoExpandHorizontalScroll")&&a.css({position:"absolute",width:"auto"}).wrap("<div class='mCSB_h_wrapper' style='position:relative; left:0; width:999999px;' />").css({width:a.outerWidth(),position:"relative"}).unwrap();var m=a.outerWidth()}else var k=c.children(".mCSB_buttonUp"),l=c.children(".mCSB_buttonDown"),n=d.height(),p=a.outerHeight();p>n&&
!b.data("horizontalScroll")&&!i(document).data("mCS-is-touch-device")?(c.css("display","block"),e=j.height(),b.data("autoDraggerLength")&&(m=Math.round(n/p*e),c=g.data("minDraggerHeight"),m<=c?g.css({height:c}):m>=e-10?g.css({height:e-10}):g.css({height:m}),g.children(".mCSB_dragger_bar").css({"line-height":g.height()+"px"})),m=g.height(),b.data("scrollAmount",(p-n)/(e-m)),b.mCustomScrollbar("scrolling",d,a,j,g,k,l,f,h),d=Math.abs(Math.round(a.position().top)),b.mCustomScrollbar("scrollTo",d,{callback:!1})):
m>e&&b.data("horizontalScroll")&&!i(document).data("mCS-is-touch-device")?(c.css("display","block"),n=j.width(),b.data("autoDraggerLength")&&(p=Math.round(e/m*n),c=g.data("minDraggerWidth"),p<=c?g.css({width:c}):p>=n-10?g.css({width:n-10}):g.css({width:p})),p=g.width(),b.data("scrollAmount",(m-e)/(n-p)),b.mCustomScrollbar("scrolling",d,a,j,g,k,l,f,h),d=Math.abs(Math.round(a.position().left)),b.mCustomScrollbar("scrollTo",d,{callback:!1})):(d.unbind("mousewheel"),d.unbind("focusin"),b.data("horizontalScroll")?
...
e.data("scrollButtons-scrollType")){var l;i.browser.msie&&9>parseInt(i.browser.version)&&e.data("scrollInertia",0);e.data("horizontalScroll")?(h.add(f).unbind("click mousedown mouseup mouseout",q,s),h.bind("click",function(a){a.preventDefault();d.is(":animated")||(l=Math.abs(d.position().left)+e.data("scrollButtons-scrollAmount"),e.mCustomScrollbar("scrollTo",l))}),f.bind("click",function(a){a.preventDefault();d.is(":animated")||(l=Math.abs(d.position().left)-e.data("scrollButtons-scrollAmount"),
d.position().left>=-e.data("scrollButtons-scrollAmount")&&(l="left"),e.mCustomScrollbar("scrollTo",l))})):(g.add(j).unbind("click mousedown mouseup mouseout",t,u),g.bind("click",function(a){a.preventDefault();d.is(":animated")||(l=Math.abs(d.position().top)+e.data("scrollButtons-scrollAmount"),e.mCustomScrollbar("scrollTo",l))}),j.bind("click",function(a){a.preventDefault();d.is(":animated")||(l=Math.abs(d.position().top)-e.data("scrollButtons-scrollAmount"),d.position().top>=-e.data("scrollButtons-scrollAmount")&&
(l="top"),e.mCustomScrollbar("scrollTo",l))}))}else if(e.data("horizontalScroll")){h.add(f).unbind("click mousedown mouseup mouseout",q,s);var n,p=a.width(),o=c.width();h.bind("mousedown",function(a){a.preventDefault();var b=p-o;n=setInterval(function(){var a=Math.abs(c.position().left-b)*(100/e.data("scrollButtons-scrollSpeed"));c.stop().animate({left:b},a,"linear");e.mCustomScrollbar("scroll")},20)});var q;h.bind("mouseup mouseout",function(a){a.preventDefault();clearInterval(n);c.stop()});var r;
f.bind("mousedown",function(a){a.preventDefault();r=setInterval(function(){var a=Math.abs(c.position().left-0)*(100/e.data("scrollButtons-scrollSpeed"));c.stop().animate({left:0},a,"linear");e.mCustomScrollbar("scroll")},20)});var s;f.bind("mouseup mouseout",function(a){a.preventDefault();clearInterval(r);c.stop()})}else{g.add(j).unbind("click mousedown mouseup mouseout",t,u);var v,x=a.height(),y=c.height();g.bind("mousedown",function(a){a.preventDefault();var b=x-y;v=setInterval(function(){var a=
Math.abs(c.position().top-b)*(100/e.data("scrollButtons-scrollSpeed"));c.stop().animate({top:b},a,"linear");e.mCustomScrollbar("scroll")},20)});var t;g.bind("mouseup mouseout",function(a){a.preventDefault();clearInterval(v);c.stop()});var w;j.bind("mousedown",function(a){a.preventDefault();w=setInterval(function(){var a=Math.abs(c.position().top-0)*(100/e.data("scrollButtons-scrollSpeed"));c.stop().animate({top:0},a,"linear");e.mCustomScrollbar("scroll")},20)});var u;j.bind("mouseup mouseout",function(a){a.preventDefault();
clearInterval(w);c.stop()})}b.unbind("focusin").bind("focusin",function(){b.scrollTop(0).scrollLeft(0);var g=i(document.activeElement);if(g.is("input,textarea,select,button,a[tabindex],area,object"))if(e.data("horizontalScroll")){var f=d.position().left,h=g.position().left,j=b.width(),g=g.outerWidth();0<=f+h&&f+h<=j-g||(g=h/e.data("scrollAmount"),g>=a.width()-c.width()&&(g=a.width()-c.width()),c.css("left",g),e.mCustomScrollbar("scroll"))}else f=d.position().top,h=g.position().top,j=b.height(),g=
...
0>c&&c<=b.height()-d.outerHeight()+a.data("onTotalScroll-Offset")?a.data("onTotalScroll-Callback").call():a.data("onScroll-Callback").call())}};i.fn.mCustomScrollbar=function(b){if(o[b])return o[b].apply(this,Array.prototype.slice.call(arguments,1));if("object"===typeof b||!b)return o.init.apply(this,arguments);i.error("Method "+b+" does not exist")}})(jQuery);
(function(i,o){if(i.jQuery!==o){jQuery.noConflict();var b=jQuery;if(b.RJS_Helpers){var d=function(){var a=this;b.extend(a,{shopName:"",shopURL:"",shopId:"",shopItems:[],count:0,initialize:function(b){a.shopName=b.shopName;a.shopURL=b.url;a.shopId=b.shopId;a.addItem(b)},addItem:function(b){a.shopItems.push(b);a.count++}})};(new function(){var a=this;b.extend(a,{settings:{init_load_row:[3,"Range","1,100"],display_row:[3,"Range","1,6"],api_max_item:[20,"Range","1,100"],cart_button_sid:["","Str","^[a-zA-Z0-9_\\-]{3,64}$"],
cart_shop_name_sid:["","Str","^[a-zA-Z0-9_\\-]{3,64}$"],cart_item_sid:["","Str","^[a-zA-Z0-9_\\-]{3,64}$"],jsonurl:["","Str","^http(s?)+(:\\/\\/[a-zA-Z0-9_\\-\\.]+)(\\.rakuten\\.co\\.jp\\/)+([a-zA-Z0-9_&=\\?\\-\\.\\/]+)$"],fadetime:[500,"Range","0,2000"],ajaxtimeout:[3E3,"Range","0,10000"],mouse_wheel_speed:[40,"Range","0,100"],adult_shopids:["","Str","^([0-9,]+)$"],adult_maskimg:["","Str","^http(s?)+(:\\/\\/[a-zA-Z0-9_\\-\\.]+)(\\.rakuten\\.co\\.jp\\/)+([a-zA-Z0-9_@&=\\?\\-\\.\\/]+)$"]},eobj:{topBasketContainer:b("#topBasketContainer"),
shopCartPopUpSettings:b("#shopCartPopUpSettings"),shopCartPrototype:b("#shopCartPrototype"),shopCartItemPrototype:b("#shopCartItemPrototype"),shopCartPopUpContainer:b("#shopCartPopUpContainer"),shopCartPopUp:b("#shopCartPopUp"),shopCartList:b("#shopCartList"),shopCartViewAll:b("#shopCartViewAll"),shopCartTopRightBox:b("#shopCartTopRightBox"),shopCartTitle:b("#shopCartTitle"),shopCartMousePlane:b("#shopCartMousePlane")},props:{shopCartPrototype:{html:"",identifiers:{shopURL:["",/\#SHOPURL\#/g,""],
shopName:["",/\#SHOPNAME\#/g,""],shopCartURL:["https://basket.step.rakuten.co.jp/rms/mall/bs/cart/?shop_bid=",/\#SHOPCARTURL\#/g,""],shopNameURL:["https://basket.step.rakuten.co.jp/rms/mall/bs/cart/?shop_bid=",/\#SHOPNAMEURL\#/g,""],bookCartURL:["https://books.step.rakuten.co.jp/rms/mall/book/bs/Cart?shop_bid=",/\#SHOPCARTURL\#/g,""],bookShopNameURL:["https://books.step.rakuten.co.jp/rms/mall/book/bs/Cart?shop_bid=",/\#SHOPNAMEURL\#/g,""]}},shopCartItemPrototype:{html:"",identifiers:{itemImg:['<img class="img" src="#IMGSRC#" title="#ITEMNAME#" alt="#ITEMNAME#" />',
/\#ITEMIMG\#/g],src:["",/\#IMGSRC\#/g,""],itemName:["",/\#ITEMNAME\#/g,""],itemURL:["http://item.rakuten.co.jp",/\#ITEMURL\#/g,""],price:["",/\#PRICE\#/g,"±ß"]}}},rendering:{shopCarts:[],shopNameLength:9,numberOfShop:0,totalItem:0,currShopIndex:0,currItemIndex:0,isFinished:!1,isResized:!1,isOldIE:!1,currShopObj:null,max_item_per_line:3,MAX_LOAD_ITEM:10,OFFSET:40},shopTypes:{rakutenBook:213310,adultShops:[]},initialize:function(){a.loadSettings()?b(document).ready(function(){a.begin()}):a.displayDefaultContents()},
loadSettings:function(){a.settings=b.RJS_Helpers.readAttr(a.eobj.shopCartPopUpSettings,a.settings);a.eobj.shopCartPopUpSettings.remove();if(""==a.settings.jsonurl)return!1;if(a.settings.init_load_row<a.settings.display_row)a.settings.display_row=a.settings.init_load_row;if(""!=a.settings.adult_shopids){for(var c=a.settings.adult_shopids.split(","),d=0;d<c.length;d++)c[d]=parseInt(c[d]);a.shopTypes.adultShops=c}return!0},indexOf:function(a,b){for(var g=0;g<a.length;g++)if(a[g]===b)return g;return-1},
begin:function(){a.getPrototypes()?a.eobj.topBasketContainer.mouseenter(function(){b(this).unbind("mouseenter");a.getData()}):a.displayDefaultContents()},getPrototypes:function(){if(0==a.eobj.shopCartPrototype.length)return!1;a.props.shopCartPrototype.html=a.eobj.shopCartPrototype.html();a.eobj.shopCartPrototype.remove();if(0==a.eobj.shopCartItemPrototype.length)return!1;a.props.shopCartItemPrototype.html=a.eobj.shopCartItemPrototype.html();a.eobj.shopCartItemPrototype.remove();return!0},getData:function(){var c;
try{c=setTimeout(function(){a.displayDefaultContents();return!1},a.settings.ajaxtimeout),b.ajax({url:a.settings.jsonurl,dataType:"jsonp",scriptCharset:"utf-8",cache:!1,timeout:a.settings.ajaxtimeout,error:function(){a.displayDefaultContents();return!1},success:function(b){clearTimeout(c);if("100"==b.status){var f=a.rendering.shopCarts,h,e;if(b.itemList.length===o)h=new d,h.initialize(b.itemList),f.push(h);else for(var j in b.itemList){e=b.itemList[j];a:{h=a.rendering.shopCarts.length;for(var k=0;k<
h;k++)if(e.shopName==a.rendering.shopCarts[k].shopName){h=k;break a}h=-1}-1==h?(h=new d,h.initialize(e),f.push(h)):f[h].addItem(e)}a.rendering.numberOfShop=f.length;a.rendering.totalItem=b.count;a.renderPopup()}else return a.displayDefaultContents(),!1}})}catch(j){return a.displayDefaultContents(),!1}return!0},renderPopup:function(){function c(c){var f=a.rendering,h,e,i=f.currShopIndex,k=f.currItemIndex,l;e=f.shopCarts[i];for(h=e.count;0<c&&!f.isFinished;){if(0==k){l=e;var n=a.props.shopCartPrototype.html,
p=a.props.shopCartPrototype.identifiers,o=void 0,q=p.shopCartURL,r=p.shopNameURL;if(l.shopId==a.shopTypes.rakutenBook)q=p.bookCartURL,r=p.bookShopNameURL;o=p.shopName[0]+l.shopName+p.shopName[2];o=o.length>a.rendering.shopNameLength?o.substr(0,a.rendering.shopNameLength)+"...":o;n=n.replace(p.shopName[1],o);n=""==a.settings.cart_button_sid?n.replace(q[1],q[0]+l.shopId+q[2]):n.replace(q[1],b.RJS_Helpers.urlParameter(q[0]+l.shopId+q[2],{"s-id":a.settings.cart_button_sid},!1));n=""==a.settings.cart_shop_name_sid?
n.replace(r[1],r[0]+l.shopId+r[2]):n.replace(r[1],b.RJS_Helpers.urlParameter(r[0]+l.shopId+r[2],{"s-id":a.settings.cart_shop_name_sid},!1));a.eobj.shopCartList.append(n);a.rendering.currShopObj=a.eobj.shopCartList.children(":last-child").children("ul:eq(0)")}l=Math.ceil((h-k)/a.rendering.max_item_per_line);if(c<l){c=k+c*a.rendering.max_item_per_line;d(e,k,c);k=c;break}else d(e,k,h),c-=l,i++,k=0,i==f.numberOfShop?(f.isFinished=!0,f.totalItem>a.settings.api_max_item&&a.eobj.shopCartViewAll.show()):
(e=f.shopCarts[i],h=e.count)}f.currShopIndex=i;f.currItemIndex=k}function d(c,f,h){for(var e=!1,i="",k=a.props.shopCartItemPrototype.identifiers,e=-1!=a.indexOf(a.shopTypes.adultShops,parseInt(c.shopId)),j=f;j<h;j++)f=a.props.shopCartItemPrototype.html,f=f.replace(k.itemImg[1],k.itemImg[0]),f=f.replace(k.src[1],k.src[0]+(e?a.settings.adult_maskimg:c.shopItems[j].itemUrl.replace(/ex=\d\dx\d\d$/g,"ex=80x80"))+k.src[2]),f=f.replace(k.itemName[1],k.itemName[0]+c.shopItems[j].itemName+k.itemName[2]),f=
f.replace(k.price[1],k.price[0]+c.shopItems[j].price.replace(/(\d)(?=(\d\d\d)+(?!\d))/g,"$1,")+k.price[2]),f=""==a.settings.cart_item_sid?f.replace(k.itemURL[1],k.itemURL[0]+c.shopItems[j].pageUrl+k.itemURL[2]):f.replace(k.itemURL[1],b.RJS_Helpers.urlParameter(k.itemURL[0]+c.shopItems[j].pageUrl+k.itemURL[2],{"s-id":a.settings.cart_item_sid},!1)),i+=f;a.rendering.currShopObj.append(i)}if(b.browser.msie&&6>=parseInt(b.browser.version))a.rendering.isOldIE=!0;(function(){for(var b=a.rendering,c=0,d=
0;d<b.numberOfShop;d++)c=Math.max(c,b.shopCarts[d].count);3<=c?(b.max_item_per_line=3,b.shopNameLength=13,a.eobj.shopCartPopUp.width(322),a.eobj.shopCartTitle.width(322)):(b.max_item_per_line=2,b.shopNameLength=9,a.eobj.shopCartPopUp.width(238),a.eobj.shopCartTitle.width(238),a.eobj.shopCartTopRightBox.width(28),a.props.shopCartItemPrototype.html=a.props.shopCartItemPrototype.html.replace('<li class="item">','<li class="item" style="margin-left: 10px; margin-right: 10px;">'))})();c(a.settings.init_load_row);
a.eobj.shopCartList.children(":first").css("border-top","none");(function(){var c=a.eobj.topBasketContainer,d=a.eobj.shopCartPopUpContainer,h=a.eobj.shopCartPopUp;a.rendering.isOldIE?c.mouseenter(function(){d.show("fast")}):c.mouseenter(function(){d.fadeIn(a.settings.fadetime);0>b("#shopCartPopUp .mCSB_dragger").position().top&&h.mCustomScrollbar("scrollTo","top");if(a.rendering.isResized)h.mCustomScrollbar("update"),a.rendering.isResized=!1});c.mouseleave(function(){d.hide()});a.eobj.shopCartTopRightBox.mouseenter(function(){d.hide()});
b(i).resize(function(){a.rendering.isResized=!0})})();a.rendering.isOldIE?a.eobj.shopCartPopUpContainer.show("fast"):a.eobj.shopCartPopUpContainer.fadeIn(a.settings.fadetime);(function(){var b=a.eobj.shopCartPopUp,d=a.eobj.shopCartList;height=Math.min(114*a.settings.display_row+60,d.outerHeight(!0)+40);b.css("height",height);a.eobj.shopCartMousePlane.css("height",height);if(a.rendering.isOldIE)b.height()<d.outerHeight(!0)&&(b.css("overflow-x","hidden"),d.width(d.width()-17)),a.eobj.topBasketContainer.mousewheel(function(c,
d){b.scrollTop(b.scrollTop()-2*a.settings.mouse_wheel_speed*d);c.preventDefault()}),b.scroll(function(){b.scrollTop()+b.height()+a.rendering.OFFSET>=d.outerHeight(!0)&&!a.rendering.isFinished&&c(a.rendering.MAX_LOAD_ITEM)});else{b.mCustomScrollbar({scrollInertia:0,scrollButtons:{enable:!0},mouseWheel:a.settings.mouse_wheel_speed,advanced:{updateOnBrowserResize:!0,updateOnContentResize:!1},callbacks:{onTotalScroll:function(){a.rendering.isFinished||(c(a.rendering.MAX_LOAD_ITEM),b.mCustomScrollbar("update"))},
onTotalScrollOffset:a.rendering.OFFSET}});var h=b.find(".mCSB_container"),e=function(c,d){var e=-h.position().top,f=3*a.settings.mouse_wheel_speed*d;e>f?b.mCustomScrollbar("scrollTo",e-f):b.mCustomScrollbar("scrollTo","top");c.preventDefault()};a.eobj.topBasketContainer.children(".basket").mousewheel(e);a.eobj.shopCartTitle.mousewheel(e)}})()},displayDefaultContents:function(){a.eobj.shopCartPopUpContainer.remove()}})}).initialize()}}})(this);
