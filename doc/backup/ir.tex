...
\usepackage{amsmath,amssymb,kotex,graphicx,fullpage,color,stmaryrd,url}
\usepackage{anysize}
...
\subsubsection*{9 Type Conversion and Testing}
...
\mbox{\inblue 14 Program}\\
%\mbox{\inblue 10.2.1.1.2 {\tt CreateMutableBinding(N{\inred , D})}}\\
